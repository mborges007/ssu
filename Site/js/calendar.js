(function ($) {
	...
	$(document).ready(function () {
		function c(passed_month, passed_year, calNum) {
			...
			clickedElement.on("click", function () {
				...
				var whichCalendar = calendar.name;
					...
					calendar.datesBody.find('.selected').removeClass('selected');
		...
		var i = ["Janeiro", "Fevereiro", "Março", "Abril", "Maio",
			...
			"Novembro", "Dezembro"];
		var daysArray = ["Domingo", "Segunda-feira", "Terça-feira",
...
$(document).ready(function () {
    // Prevent form submission when the switch-month buttons are clicked
    $('.switch-month').on('click', function (event) {
